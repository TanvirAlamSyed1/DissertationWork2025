...
class MainPage(tk.Frame):
    ...
    def toggle_edit_mode(self):util_edit_mode.toggle_edit_mode(self)
    def on_edit_press(self,event=None):util_edit_mode.on_edit_press(self,event)
    def on_edit_drag(self,event=None):util_edit_mode.on_edit_drag(self,event)
    def on_edit_release(self,event=None):util_edit_mode.on_edit_release(self,event)
